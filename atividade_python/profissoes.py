class Profissoes():
    ...
    def selecionar_cargo_bonificacao(self):
        ...
        if self.cargo == '1':
            ...
            print(f'Bonificação é 15% receberá como Professor é R${self.bonificacao:.2f} conforme salario mensal de R${self.salario:.2f}')
        elif self.cargo == '3':
            self.bonificacao = self.salario*0.2
            print(f'Bonificação é 20% receberá como Programador é R${self.bonificacao:.2f} conforme salario mensal de R${self.salario:.2f}')
        elif self.cargo == '4':
            self.bonificacao = self.salario*0.3
            print(f'Bonificação é 30% receberá como Gerente é R${self.bonificacao:.2f} conforme salario mensal de R${self.salario:.2f}')
        elif self.cargo == '5':
            self.bonificacao = self.salario*0.15
            print(f'Bonificação é 15% receberá como Analista é R${self.bonificacao:.2f} conforme salario mensal de R${self.salario:.2f}')
        else:
